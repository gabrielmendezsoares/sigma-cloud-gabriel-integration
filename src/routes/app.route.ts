...
import { appService, createSigmaCloudEventsService } from "../services/index.js";
    ...
    generateRoute(
      {
        method: 'post',
        version: 'v1',
        url: 'create/sigma-cloud-events',
        serviceHandler: createSigmaCloudEventsService.createSigmaCloudEvents,
